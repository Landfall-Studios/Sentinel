...
public class VelocityReputationCommand implements SimpleCommand {

    private final DatabaseManager db;
    private final ReputationManager repManager;
    private final Logger logger;

    public VelocityReputationCommand(DatabaseManager db, ReputationManager repManager, Logger logger) {
        this.db = db;

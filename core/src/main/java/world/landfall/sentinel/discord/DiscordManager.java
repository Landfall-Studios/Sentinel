...
public class DiscordManager extends ListenerAdapter {
    ...
    public DiscordManager(DatabaseManager db, String token, String linkedRoleId, String quarantineRoleId, String[] staffRoles, PlatformAdapter platformAdapter, SentinelConfig config, Logger logger) {
        this.db = db;
        this.token = token;
